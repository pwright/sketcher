...
> **Note:** This is the developer/contributor documentation. If you want to **use** Sketcher to create Skupper examples, see the [main documentation](../index.md) instead.
...
See the Architecture section below for details on why standard steps were removed and the benefits of this approach.
...
- [Compatibility](../migration/compatibility.md) - Behavioral compatibility and migration guide
- [Use Cases](../user-guide/use-cases.md) - Real-world examples and platform-specific workflows
- [Schema Documentation](schema.md) - Complete field reference
- [Contributing](contributing.md) - How to contribute to Sketcher
